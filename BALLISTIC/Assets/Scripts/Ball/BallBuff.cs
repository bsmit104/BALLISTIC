...
public abstract class BallBuff : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="ball">The ball this buff is attached to.</param>
    protected abstract void OnSpawnBuff(NetworkDodgeball ball);
    ...
    public abstract void OnThrow(NetworkPlayer thrower, Vector3 throwDirection);
